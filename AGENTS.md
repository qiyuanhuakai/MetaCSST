...
This project is indexed by GitNexus as **MetaCSST.structure** (340 symbols, 696 relationships, 24 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/MetaCSST.structure/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/MetaCSST.structure/context` | Codebase overview, check index freshness |
| `gitnexus://repo/MetaCSST.structure/clusters` | All functional areas |
| `gitnexus://repo/MetaCSST.structure/processes` | All execution flows |
| `gitnexus://repo/MetaCSST.structure/process/{name}` | Step-by-step execution trace |
