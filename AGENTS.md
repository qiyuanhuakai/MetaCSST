...
This project is indexed by GitNexus as **MetaCSST.refact** (237 symbols, 491 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
