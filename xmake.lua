...
task("example")
    ...
    on_run(function ()
        ...
        print("     ./MetaCSSTmain -build config.toml -in example/hv29.fa -out example/run_out_toml -thread 2")
        print("  3) Build models + run with YAML config")
        print("     ./MetaCSSTmain -build config.yaml -in example/hv29.fa -out example/run_out_yaml -thread 2")
